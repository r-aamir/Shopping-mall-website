...
class Category
{
     ...
     * @ORM\OneToMany(targetEntity="\ProductDisplay\Entity\Category", mappedBy="parent")
     */
    private $childrens;

    /**
     * Many Categories have One Category.
     * @ORM\ManyToOne(targetEntity="\ProductDisplay\Entity\Category", inversedBy="children")
