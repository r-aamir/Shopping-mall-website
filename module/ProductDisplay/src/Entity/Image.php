...
class image
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\ProductDisplay\Entity\ProductColorImage", inversedBy="images")
     ...
     * @return \ProductDisplay\Entity\ProductColorImage
     */
     ...
     * @param \ProductDisplay\Entity\ProductColorImage $product_color_image
     */
