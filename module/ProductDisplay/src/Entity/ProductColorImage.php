...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="\ProductDisplay\Repository\ProductColorImageRepository")
...
class ProductColorImage
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\ProductDisplay\Entity\Product", inversedBy="product_color_images")
    ...
    public function setProduct($product) 
    {
     ...
     /**
     * @ORM\OneToMany(targetEntity="\ProductDisplay\Entity\Image", mappedBy="product_color_image")
